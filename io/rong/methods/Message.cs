...
namespace donet.io.rong.methods {
    ...
    public class Message:IDisposable {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> publishTemplateAsync(TemplateMessage templateMessage) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> PublishSystemAsync(String fromUserId, String[] toUserId, TxtMessage message, String pushContent, String pushData, int isPersisted, int isCounted) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> publishSystemTemplateAsync(TemplateMessage templateMessage) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> publishGroupAsync(String fromUserId, String[] toGroupId, TxtMessage message, String pushContent, String pushData, int isPersisted, int isCounted) {
			...
			postStr += "toGroupId=" + HttpUtility.UrlEncode(child) + "&";
			}
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> broadcastAsync(String fromUserId, TxtMessage message, String pushContent, String pushData, String os) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> deleteMessageAsync(String date) {
