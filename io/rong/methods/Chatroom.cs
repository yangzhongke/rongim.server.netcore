...
namespace donet.io.rong.methods {
    ...
    public class Chatroom {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> joinAsync(String[] userId, String chatroomId) {
		 ...
		 *
	 	 ...
	 	 **/
		public async Task<ChatroomQueryReslut> queryAsync(String[] chatroomId) {
		 ...
		 *
	 	 ...
	 	 **/
		public async Task<ChatroomUserQueryReslut> queryUserAsync(String chatroomId, String count, String order) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> stopDistributionMessageAsync(String chatroomId) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> resumeDistributionMessageAsync(String chatroomId) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> addGagUserAsync(String userId, String chatroomId, String minute) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> rollbackGagUserAsync(String userId, String chatroomId) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> addBlockUserAsync(String userId, String chatroomId, String minute) {
		 ...
		 *
	 	 ...
	 	 **/
		public async Task<ListBlockChatroomUserReslut> getListBlockUserAsync(String chatroomId) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> rollbackBlockUserAsync(String userId, String chatroomId) {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> addPriorityAsync(String[] objectName) {
			...
			postStr += "objectName=" + HttpUtility.UrlEncode(child) + "&";
			}
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
		public async Task<CodeSuccessReslut> addWhiteListUserAsync(String chatroomId, String[] userId) {
